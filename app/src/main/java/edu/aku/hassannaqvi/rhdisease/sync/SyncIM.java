...
import edu.aku.hassannaqvi.rhdisease.contracts.SectionKIMContract.singleIm;
...
public class SyncIM extends AsyncTask<Void, Void, String> {
    ...
    protected void onPreExecute() {
        ...
        pd.setTitle("Please wait... Processing IM");
        pd.show();
