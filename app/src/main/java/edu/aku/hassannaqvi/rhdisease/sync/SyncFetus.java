 ...
 */
public class SyncFetus extends AsyncTask<Void, Void, String> {
    ...
    public SyncFetus(Context context) {
        mContext = context;
    }
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            String url = MainApp._HOST_URL + FormsContract.FormsTable._URL.replace(".php", "fetus.php");
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            pd.setMessage(sSynced + " Fetus synced." + String.valueOf(json.length() - sSynced) + " Errors: " + sSyncedError);
            pd.setTitle("Done uploading Fetus data");
            pd.show();
    ...
    private String downloadUrl(String myurl) throws IOException {
        ...
        //  int len = 500;
        DatabaseHelper db = new DatabaseHelper(mContext);
        Collection<FetusContract> forms = db.getUnsyncedFetus();
        ...
        if (forms.size() > 0) {
            try {
                ...
                try {
                    ...
                    for (FetusContract fec : forms) {

                        jsonSync.put(fec.toJSONObject());
