 ...
 */
public class SyncForms8 extends AsyncTask<Void, Void, String> {

    private static final String TAG = "SyncForms8";
    private Context mContext;
    private ProgressDialog pd;


    public SyncForms8(Context context) {
        mContext = context;
    }
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            String url = MainApp._HOST_URL + FormsContract.FormsTable._URL.replace(".php", "8.php");
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            Toast.makeText(mContext, sSynced + " Forms4 synced." + String.valueOf(json.length() - sSynced) + " Errors: " + sSyncedError, Toast.LENGTH_SHORT).show();
    ...
    private String downloadUrl(String myurl) throws IOException {
        ...
        //  int len = 500;
        DatabaseHelper db = new DatabaseHelper(mContext);
        Collection<FormsContract> forms = db.getUnsyncedForms8();
